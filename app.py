...
if uploaded_file:
    ...
    # Always apply current zoom to the original image
    if st.session_state.original_image:
        try:
            # Create scaled version (using high-quality resampling)
            ...
            if cred_file:
                try:
                    ...
                    # Display the overlay (also zoomed)
            ...
            st.error(f"Image scaling failed: {e}")
